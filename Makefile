...
BUILTINS	=	$(addprefix srcs/builtins/, ft_echo.c ft_exit.c)
PROMPT 	=	$(addprefix srcs/parse_prompt/, handle_dollars/replace_vars.c)
...
${OBJDIR}:
	...
	@mkdir -p ${OBJDIR}/srcs/parse_prompt/handle_dollars
